...
from src.planners.pdm_planner.simulation.batch_kinematic_bicycle import (
    BatchKinematicBicycleModel,
)
from src.planners.pdm_planner.simulation.batch_lqr import (
    BatchLQRTracker,
)
...
class PDMSimulator:
    ...
    def simulate_proposals(
        ...
        simulated_states = np.zeros((proposal_states.shape[0], proposal_states.shape[1], 11), dtype=np.float64)
